package com.example.anand38.jobportal.Configurations;
...
public class AppConfig {
    public static String login_check_url="http://env-7697253.j.layershift.co.uk/rest/login_service/getloginstatus";
